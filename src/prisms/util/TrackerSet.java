...
{
	private static final Logger log = Logger.getLogger(TrackerSet.class);
	...
	{
		if(isConfigured)
			throw new IllegalStateException("Tracker Set " + theName
				+ " is already configured--no more track configs may be added");
		theLock.lock();
		try
		{
