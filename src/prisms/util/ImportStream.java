...
public class ImportStream extends java.io.InputStream
{
	...
	{
		String test = "This is a test.  This is only a test.  If this had been an actual string, it"
		...
		writer.write(test);
		writer.close();
		java.io.Reader reader = new java.io.InputStreamReader(new ImportStream(
