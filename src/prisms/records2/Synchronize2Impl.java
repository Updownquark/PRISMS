...
/**
 * Interfaces between a {@link PrismsSynchronizer2} and a java object data set. Each instanceof an
 * {@link Synchronize2Impl} has a set of objects that it administrates. Its methods allow a
 * synchronizer to keep the impl's data in sync with another impl at another location.
 */
public interface Synchronize2Impl
{
	 ...
	 */
	prisms.records2.SubjectType getSubjectType(String typeName) throws PrismsRecordException;
	 ...
	 */
	prisms.records2.RecordPersister2.ChangeData getData(SubjectType subjectType,
	 ...
	 * @param reader The item reader that may be needed to serialize a piece of the major subject
	 * @throws PrismsRecordException If an error occurs performing the change
	 */
	void doChange(ChangeRecord change, Object currentValue, ItemReader reader)
		throws PrismsRecordException;
