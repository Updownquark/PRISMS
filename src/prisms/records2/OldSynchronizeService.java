 ...
 */
public abstract class OldSynchronizeService implements prisms.arch.AppPlugin
{
	private static final Logger log = Logger.getLogger(OldSynchronizeService.class);
	...
	public void processEvent(JSONObject evt)
	{
		...
		OldPrismsSynchronizer<?> synchronizer = getSynchronizer();
		...
		else if("getNewItemCount".equals(evt.get("method")))
		{
			...
			ret.put("itemCount",
				new Integer(synchronizer.getItemCount(center, sinceTime, theSession.getApp())));
		}
	 ...
	 */
	protected abstract OldPrismsSynchronizer<?> getSynchronizer();
}
