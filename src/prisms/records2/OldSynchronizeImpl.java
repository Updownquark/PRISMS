 ...
 */
public interface OldSynchronizeImpl<SyncDataType extends OldSynchronizeImpl.SyncData>
{
	/**
	...
	public static class SyncData
	{
		 ...
		 */
		public final OldPrismsSynchronizer<?> synchronizer;
		 ...
		 */
		public SyncData(OldPrismsSynchronizer<?> sync, PrismsCenter _center,
			PrismsApplication anApp, DefaultProgressInformer _pi, Object [] _items,
			ChangeRecord [] _mods)
		{
			synchronizer = sync;
			center = _center;
	 ...
	 */
	SyncDataType genSyncData(OldPrismsSynchronizer<? super SyncDataType> synchronizer,
