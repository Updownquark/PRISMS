/*
 * ChangeRecordError.java Created Aug 2, 2010 by Andrew Butler, PSL
 */
...
public class ChangeRecordError extends ChangeRecord
{
	 ...
	 */
	public ChangeRecordError(long _id, long _time, RecordUser _user)
	{
		super(_id, _time, _user, ErrorSubjectType, ErrorChangeTypes.VALUE, 0, ErrorSubjectType,
			null, null, null, null);
	}
