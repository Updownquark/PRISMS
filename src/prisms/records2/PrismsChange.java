...
public enum PrismsChange implements SubjectType
{
	 ...
	 */
	autoPurge(AutoPurger2.class, null, null, AutoPurgeChange.class);
	...
	{
		/**
		 * @see AutoPurger2#getEntryCount()
		 * @see AutoPurger2#setEntryCount(int)
		 */
		entryCount(null, Integer.class, false),
		/**
		 * @see AutoPurger2#getAge()
		 * @see AutoPurger2#setAge(long)
		 */
