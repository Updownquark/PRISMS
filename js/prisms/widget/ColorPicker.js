...
__dojo.provide("prisms.widget.ColorPicker");
__dojo.declare("prisms.widget.ColorPicker", [__dijit._Widget, __dijit._Templated], {

	templatePath: "__webContentRoot/view/prisms/templates/colorPicker.html",
...
//		__dojo.marginBox(this.colorHexagon, {t:-height+1});
//		__dojo.marginBox(this.shade, {t:-height*2+1});
//		__dojo.marginBox(this.hexagonCell, {h:height});
	},
	...
	_colorClicked: function(evt){
		...
		var coords=__dojo.coords(this.alphaHexagon);
		x-=coords.x;
		y-=coords.y;
	...
	_positionMarker: function(value){
		...
		__dojo.marginBox(this.marker, {t: Math.round(y)-2, l:Math.round(x)-2});  
	},
	...
	_beforeClicked: function(){
		this.setValue(this.beforeColor, true);
	},
	...
	_notifyUserLater: function(){
		...
		{
			this._notificationThread=setInterval(__dojo.hitch(this, function(){
