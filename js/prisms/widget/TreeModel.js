...
__dojo.provide("prisms.widget.TreeModel");
__dojo.declare("prisms.widget.TreeModel", null, {
	...
	shutdown: function(){
		...
		this.theValue.path=[this.theValue.id];
		this.refreshFromData(this.theValue);
	},
