...
__dojo.require("dijit._Widget");
__dojo.require("prisms.widget.LayerConfigurator");
__dojo.provide("prisms.widget.ImageMap");
...
function MapDragImageUtil(map){
	...
	this.drag=function(x, y, w, h){
		...
		__dojo.marginBox(this.images[imDiv][imDiv], {t: this.map.imageTop+y,
			l: x, w: w, h: h});
		...
		for(var r=-imDiv;r<=imDiv;r++)
		{
			...
			for(var c=-imDiv;c<=imDiv;c++)
			{
				...
				__dojo.marginBox(this.images[r+imDiv][c+imDiv], box);
			}
		}
	};
...
__dojo.require("dijit.layout._LayoutWidget");
__dojo.require("dijit._Templated");

__dojo.declare("prisms.widget._ImageMapMenuItem",
	__dijit.MenuItem,
	{
		postCreate: function()
		{
...
__dojo.declare("prisms.widget.ImageMap", [__dijit.layout._LayoutWidget, __dijit._Templated],
{
	templatePath: "__webContentRoot/view/prisms/templates/imageMap.html",
	...
	postCreate: function(){
		...
		{
			this.popupMenu=new __dijit.Menu({});
			...
			__dojo.connect(this.popupMenu, "_openMyself", this, this.addMenuItems);
		}
	...
	refreshImage: function(noCache){
		...
		__dojo.marginBox(this.blanketDiv, {l:0, t: this.imageTop,
	...
	_imageLoaded: function(){
		...
		{
			__dojo.marginBox(this.imageTag, {l: 0, t: this.imageTop, w: this.imageWidth, h: this.imageHeight});
	...
	_mouseModeRotate: function(){
		if(this.isAreaSelecting)
		{
			...
			{ //Move to map dragging mode, where dragging the mouse moves the map around like google maps
				...
				__dojo.marginBox(this.dragMoveButton,
			...
			else
			{
				...
				__dojo.marginBox(this.normalSelectButton,
		...
		else
		{
			...
			this.dragMoveButton.style.display="none";
			this.normalSelectButton.style.display="none";
			__dojo.marginBox(this.areaSelectButton,
	...
	addMenuItemsFromActions: function(message, actions)
	{
		...
		if(items.length==0)
		{
			...
			items[1]=new __dijit.MenuSeparator({});
	...
	layout: function(){
		...
		if(this.showToolBar)
		{
			...
			__dojo.marginBox(this.buttonPanel, {l: 0, t: 0, w: this.domNode.clientWidth, h: height});
	
			var left=0;
			__dojo.marginBox(this.panLeftButton, {l: left, t: (height-this.panLeftButton.clientHeight)/2});
			left+=this.panLeftButton.clientWidth;
			__dojo.marginBox(this.panUpButton, {l: left,
				t: (height-this.panUpButton.clientHeight-this.panDownButton.clientHeight-2)/2});
			__dojo.marginBox(this.panDownButton, {l: left,
			...
			__dojo.marginBox(this.panRightButton, {l: left, t: (height-this.panRightButton.clientHeight)/2});
			left+=this.panRightButton.clientWidth;
			left+=10;
			__dojo.marginBox(this.zoomInButton, {l: left, t: (height-this.zoomInButton.clientHeight)/2});
			left+=this.zoomInButton.clientWidth;
			left+=5;
			__dojo.marginBox(this.zoomOutButton, {l: left, t: (height-this.zoomOutButton.clientHeight)/2});
			left+=this.zoomOutButton.clientWidth;
			left+=10;
			__dojo.marginBox(this.areaSelectButton, {l: left,
				t: (height-this.areaSelectButton.clientHeight)/2});
			__dojo.marginBox(this.dragMoveButton, {l: left,
				t: (height-this.dragMoveButton.clientHeight)/2});
			__dojo.marginBox(this.normalSelectButton, {l: left,
			...
			if(this.configPluginName)
			{
				...
				__dojo.marginBox(this.layersConfigureButton, {l: left,
		...
		__dojo.marginBox(this.waitIcon, {l: this.imageWidth/2-this.waitIcon.clientWidth/2,
